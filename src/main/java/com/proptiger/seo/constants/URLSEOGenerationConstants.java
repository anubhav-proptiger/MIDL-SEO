...
public class URLSEOGenerationConstants {
    ...
    public static String       SelectorGetBuilderById         = "{\"filters\":{\"and\":[{\"equal\":{\"id\":%d}}]},\"fields\":[\"id\",\"name\",\"builderCities\",\"url\"]}";
    public static String       SelectorGetCityByName          = "{\"filters\":{\"and\":[{\"equal\":{\"label\":\"%s\"}}]},\"fields\":[\"id\",\"label\",\"url\"]}";
    public static String       SelectorGetCityById            = "{\"filters\":{\"and\":[{\"equal\":{\"id\":%d}}]},\"fields\":[\"id\",\"label\",\"url\"]}";
